...
import { Question, QuestionControllerService, QuestionEditRequest } from '@/api'
...
const doSubmit = async () => {
  const questionRequest: QuestionEditRequest = {
    answer: form.answer,
  ...
  const res = await QuestionControllerService.editQuestionUsingPost(questionRequest)
  if (res.code === 0) {
